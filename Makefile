...
run_hw: wsr_host_hw wsr_multibin
	cd $(BIN_DIR); ./wsr_host_hw 1 1 

run_hw_trace: wsr_host_hw wsr_multibin
	cd $(BIN_DIR); ${K1_TOOLCHAIN_DIR}/bin/k1-trace-util  -a -l 0XFF --background=./k1-trace-util.pid ; ./wsr_host_hw 4 16 ; kill -SIGINT `cat ./k1-trace-util.pid`
